...
#
# Perl script to buffer concurrent SGE job output using lock files on Toolforge.
#  This should be ported to gawk. See JHNC's answer for a possibility:
#   https://stackoverflow.com/questions/50848767/prevent-two-or-more-instances-of-awk-from-simultaneously-writing-to-the-same-fil
#
...
$MAXAGE = 60; # max age in seconds that the buffer is allowed to be unwritten
$BLOB = ""; # the buffer
